  ...
  ?>
      <center>
        ...
        ?><input type="text" value="<?php echo $base_url;
                                    echo "/";
                                    echo $slug; ?>" id="myInput">

        <div class="tooltip"><button onclick="myFunction()" onmouseout="outFunc()"><span class="tooltiptext" id="myTooltip">Copy to clipboard</span>Copy URL</button></div>
      </center>
    <?php
